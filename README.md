...
- Adding a feature where the user can name the file as they please
  (didn't add it since this was a project mainly for learning structs ;p)
- Reordering the sequence of setting variables to be more memory efficient
- Adding the ability to search through any CSV file the user inputs not just the test file